...
/**
 * Composable for displaying detection patterns chart
 */
@Composable
fun DetectionPatternsChart(detectionEvents: List<DetectionEvent>, modifier: Modifier = Modifier) {
    Card(
        modifier = modifier
            .fillMaxWidth()
            .height(300.dp),
